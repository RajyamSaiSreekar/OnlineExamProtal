    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/examProtal/userModule/users", "/examProtal/userModule/{id}/role","qb/addQuestion","qb/addMultipleQuestions","qb/uploadFile","qb/getquestion/{id}","qb/getAll","qb/updQuestion/{id}","qb/delQuestion/{id}","qb/getByCategory/{category}","qb/getByDifficulty/{difficulty}","/api/admin/exams/update/{id}","/api/admin/exams/delete/{id}","/api/admin/exams/role/{id}","/mapping/{examId}/{questionId}","/mapping/exam/{examId}","/mapping/allexams","mapping/exam/{examId}/adminQues","/api/exams/exam/{examId}","/api/exams/{examId}/responses/{userId}").hasRole("ADMIN")
                // Other endpoints require authentication
                .requestMatchers("qb/attemptQuestions","mapping/exam/{examId}/questions","/api/exams/{examId}/submit","/api/exams/responses/{userId}").hasAnyRole("ADMIN","STUDENT")
